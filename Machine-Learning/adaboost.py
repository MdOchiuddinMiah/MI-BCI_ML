# -*- coding: utf-8 -*-
"""
Created on Mon May 27 23:23:34 2019
...
#print('Accuracy on the training subset: {:.3f}'.format(ada.score(X_train, y_train)))
print('ok')
print('Accuracy on the test subset: {:.3f}'.format(ada.score(X_test, y_test)))
